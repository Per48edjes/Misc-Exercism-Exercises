...
def value_of_ace(card_one, card_two):
    ...
    hand_value = (
        ...
        else 11 + max(value_of_card(card_one), value_of_card(card_two))
    )
    return 11 if (21 >= hand_value + 11) else 1
...
def is_blackjack(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    return value_of_card(card_one) + value_of_card(card_two) == 11 and "A" in (
        card_one,
        card_two,
    )
