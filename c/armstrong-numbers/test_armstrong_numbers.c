...
// Custom tetst
static void test_is_armstrong_number_0_does_not_raise_exception(void)
{
   feclearexcept(FE_DIVBYZERO);
   is_armstrong_number(0);
   TEST_ASSERT_FALSE(fetestexcept(FE_DIVBYZERO));
}
...
int main(void)
{
   ...
   RUN_TEST(test_is_armstrong_number_0_does_not_raise_exception);
